export const portfolioDataFr = {
  ...
  location: "Maurice 🌊",
  bio: "Développeur Full-Stack spécialisé en .NET et Angular. À l'aise avec la conteneurisation via Docker, les langages de requête PostgreSQL, NoSQL (Firebase) et MS SQL, ainsi qu'avec les pipelines CI/CD et les bus de messages comme RabbitMQ.",
  ...
  skills: [
    ...
    { name: "PostgreSQL/ MS SQL", category: "Données" },
    { name: "NoSQL", category: "Données" },
  ...
  ui: {
    ...
    skills: {
      ...
      subtitle: "Voici ma boîte à outils.",
      filterAll: "Tout",
      stats: [
